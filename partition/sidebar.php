...
if ($currentPage == "index-admin.php") {
...
} elseif (!empty($_SESSION['admin']['nama_admin'])) {
    $userName = $_SESSION['admin']['nama_admin'];
} else {
    $userName = 'Guest';
}
?>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="height: 100vh;"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                ...
                <ul class="nav flex-column ms-4 submenu">
                    <li>
                        <a href="all-account.php"
                        class="nav-link d-flex align-items-center
                        
                        <?php if ($currentPage == 'all-account.php') echo 'active';?>
                        "> All Account</a>
                    </li>
                    <li>
                        ...
                        <?php if ($currentPage == 'client-account.php') echo 'active';?>
                        "> Client Account</a>
                    </li>
                    <li>
                        <a href="psikolog-account.php"
                        class="nav-link d-flex align-items-center
                        
                        <?php if ($currentPage == 'psikolog-account.php') echo 'active';?>
                        "> Psikolog Account</a>
                    </li>
                    <li>
                        ...
                        <?php if ($currentPage == 'add-account.php') echo 'active';?>
                        "> Add Account</a>
                    </li>
                </ul>
            </li>
